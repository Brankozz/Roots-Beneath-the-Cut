...
def input_args():
    ...
    parser.add_argument('--select_ratio', type=float, default=0)
...
def main():
    ...
    # save the model
    ckpt_name = os.path.join(args.checkpoint_path, f'skill_ratio_{args.skill_ratio}_accumlate_timesteps_{args.timesteps}_threshold{args.select_ratio}.pt')
